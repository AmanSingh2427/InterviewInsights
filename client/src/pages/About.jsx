      ...
      <div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            ...
            <div class="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                <div class="w-full lg:w-6/12">
                    <h2 class="w-full font-bold lg:text-4xl text-3xl lg:leading-10  leading-9">About our Application</h2>
                    <p class="font-normal text-base leading-6 text-gray-600  mt-6">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum.In the first place we have granted to God, and by this our present charter confirmed for us and our heirs forever that the English Church shall be free, and shall have her rights entire,</p>
                </div>
                <div class="w-full lg:w-6/12">
                    <img class="lg:block hidden w-full" src="https://static.ambitionbox.com/static/homepage/companies_web.svg" alt="people discussing on board" />
                    <img class="lg:hidden sm:block hidden w-full" src="https://static.ambitionbox.com/static/homepage/companies_web.svg" alt="people discussing on board" />
                    <img class="sm:hidden block w-full" src="https://static.ambitionbox.com/static/homepage/companies_web.svg" alt="people discussing on board" />
                </div>
            </div>
            ...
            <div class="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                <div>
                    <p class="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800  mt-6">Company Details</p>
                ...
                <div>
                    <p class="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800  mt-6">Interview Experiences</p>
                    <p class="font-normal text-base leading-6 text-gray-600  mt-6">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                </div>
                <div class="sm:block hidden">
                    <p class="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800  mt-6">InterView Questions</p>
                    <p class="font-normal text-base leading-6 text-gray-600  mt-6">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                </div>
            </div>
